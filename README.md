...
Optimizations
I plan to integrate a backend component using NodeJs and MongoDB. I would like for the owner of the business to be able to have access to each cheesecake order (outside of PayPal). Eventually I would like to add an email component as well, which will email the user once the order has been placed and also email the business owner an order summary.
